import {extractDomain,GetAllProducts,RefreshCart,addToCart,CreateModal,name,RefreshButtonswishlist,AddWishlist} from "../Start.js"
//filter
...
if(Domain==="Vercel"){
    ...
    pathcss=file.join("")+"/components/Shop/styles.css"
}
else{
    pathcss="/"+file.join("")+"/components/Shop/styles.css"
